"""
Gemeinsame Test-Hilfsfunktionen für alle Tests.

Dieses Modul kann normal importiert werden (im Gegensatz zu conftest.py,
das nur von pytest auto-discovered wird).
"""
import os
import tempfile
import pandas as pd
